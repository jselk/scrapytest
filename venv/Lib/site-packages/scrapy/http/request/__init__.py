...
class Request(object_ref):
    ...
    attributes: Tuple[str, ...] = (
        ...
        "dont_filter", "dont_encode", "errback", "flags", "cb_kwargs",    # New attribute listed here
    )
    ...
    def __init__(
        ...
        dont_encode: bool = False,    # New parameter
        ...
        self._set_url(url, dont_encode)    # Added dont_encode as argument to this method
        self._set_body(body)
        ...
        self.dont_encode = dont_encode    # New parameter
    ...
    def _set_url(self, url: str, dont_encode: bool) -> None:
        if not isinstance(url, str):
            raise TypeError(f"Request url must be str, got {type(url).__name__}")

        if dont_encode == False:    # If encoding is disabled by user, this will be skipped
            s = safe_url_string(url, self.encoding)
            self._url = escape_ajax(s)
        else :
            self._url = url    # Assures that url does not change
